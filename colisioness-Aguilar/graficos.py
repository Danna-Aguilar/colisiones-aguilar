...
def colisoniando():
    ...
    #Extremo der. del triangulo >= Extremo izq. cuadrado
    #Extremo izq. del triangulo <= Extremo der. cuadrado
    #Extremo sup. del triangulo >= Extremo inf. del cuadrado
    #Extremo inf. del triangulo <= Extremo sup. del cuadrado
